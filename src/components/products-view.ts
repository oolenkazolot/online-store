...
class ProductsView {
  ...
  constructor(productsList: IProductsList) {
    ...
    this.productsSort = new ProductsSort(this.productsList.draw.bind(this.productsList));
  }
  public createProductsViewBlock(router?: IRouter): HTMLElement {
    ...
    const productsSortBlock: HTMLElement = this.productsSort.createProductsSort(router);
