...
class Filter {
  ...
  constructor(drawProductList: () => void) {
    ...
    this.filterRange1 = new FilterRange('price', this.minMaxPrice[0], this.minMaxPrice[1], this.minMaxPriceValue[0], this.minMaxPriceValue[1], this.drawProductList);
    this.filterRange2 = new FilterRange('stock', this.minMaxStock[0], this.minMaxStock[1], this.minMaxStockValue[0], this.minMaxStockValue[1], this.drawProductList);
  }
